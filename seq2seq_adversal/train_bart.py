...
if __name__ == '__main__':
    ...
    parser.add_argument('--fp16', type=str, default='yes', help='')
    ...
    parser.add_argument('--gradient_accumulation_steps', type=int, default=3, help='')
    ...
    parser.add_argument('--mid_dim', type=int, default=800, help='')
    ...
    if args.mode == 'e2e':
        ...
        data_dir = '/home/hadoop-aipnlp/cephfs/data/zengweihao02/NAACL2021/Prefix-Tuning/seq2seq_adversal/data/train_adversial/train_as_test'
        folder_name = "./data/save_checkpoint/train_as_test/"
    ...
    OLD_MODEL = '/home/hadoop-aipnlp/cephfs/data/zengweihao02/NAACL2021/Prefix-Tuning/seq2seq/model/pegasus-large/pegasus-large'
